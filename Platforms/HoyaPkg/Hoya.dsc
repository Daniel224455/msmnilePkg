...
[Defines]
  ...
  OUTPUT_DIRECTORY               = Build/HoyaPkg
...
[LibraryClasses.common]
  ...
  PlatformConfigurationMapLib|HoyaPkg/Device/$(TARGET_DEVICE)/Library/PlatformConfigurationMapLib/PlatformConfigurationMapLib.inf
